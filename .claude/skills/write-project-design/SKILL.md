...
Follow them through to the project plan's own pair, and follow those. The work file carries how the
...
from passing review. A change touching the system design instead follows that branch, through the same two
files.
