...
carries the drafting order, the service classifications, the diagrams and the rules; the
**completion bar** carries what must be true before the draft is reviewable. The same bar is
what the review applies, so satisfying it is not a separate exercise from passing review.
