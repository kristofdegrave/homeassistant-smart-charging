...
- Artifact work: the work file in the issue's row of `CLAUDE.md`'s **Model selection** table,
  reached through the entry point the row names. Cite the row, don't restate the table. The
