...
description: "Use when addressing review findings on a pull request — from the AI review loop (a PR comment containing `ai-review-verdict: remarks`) or from a human review. CI's entry for step 3; an interactive session reaches it through the `fix` skill rather than directly."
---
