...
- **Honor the structural ADRs** as you code:
  ...
  - Native entity naming (ADR-0004); config data/options split (ADR-0005); package layout
    (ADR-0002/0010).
- **Definition of Done** (use `verification-before-completion`): the generic checklist in
  `CLAUDE.md`'s development workflow covers this — ruff/pytest green, coverage matches the
