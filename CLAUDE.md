...
chain at that step. Only the **Clean up** step is never reached by the chain running onward: it
starts from the human stating that the merge happened. The rules behind both are that doc's
**Rule B** and **Rounds and the cap** sections.
