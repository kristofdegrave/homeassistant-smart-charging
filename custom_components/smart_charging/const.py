...
PEAK_WINDOW_SECONDS = 900  # E5 15-minute averaging window (design doc Sec 6.4). Shared by
# coordinator.py's own fallback and __init__.py's setup-time CONF_PEAK_WINDOW_SIZE derivation
