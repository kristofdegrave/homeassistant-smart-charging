...
service architecture those decisions sit inside — this document is that statement, and drafting
it is what surfaces which boundaries need an ADR at all. Where it sits in the pipeline is the
**Design** stage of [idea-to-product.md](../../../method/idea-to-product.md#7-design).
