...
template. A row marked `Abandoned` is an ADR dropped before its decision was
taken, kept so the log has every number.
...
| [0006](0006-coordinator-and-data-flow.md) | Coordinator and data flow — step 2's smoothed-reading list, and the smoothed-set half of its forward-looking bar, narrowed by [ADR-0036](0036-step-2-smooths-net-power-only.md); step 2's raw charger power, for step 6's solar surplus, narrowed by [ADR-0049](0049-solar-surplus-smooths-net-and-charger-power-together.md), and for R5's escalated-rate forecast by [ADR-0051](0051-r5-forecast-reads-the-admitted-joint-mean.md) | Accepted |
...
| [0036](0036-step-2-smooths-net-power-only.md) | The control cycle's step 2 smooths net power only — which readings are smoothed is an R10 matter; its restated raw charger power, for step 6's solar surplus, narrowed by [ADR-0049](0049-solar-surplus-smooths-net-and-charger-power-together.md), and for R5's escalated-rate forecast by [ADR-0051](0051-r5-forecast-reads-the-admitted-joint-mean.md) | Accepted |
