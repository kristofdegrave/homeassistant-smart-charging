...
| [0044](0044-implementation-spec-lives-in-the-epic-body.md) | The implementation spec lives in its epic's body and its tasks in the child issues, each carrying the anchored sources it was cut from; `docs/plans/**` and the `specs` work type are retired | Accepted |
