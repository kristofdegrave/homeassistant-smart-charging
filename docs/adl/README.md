...
| [0016](0016-entity-to-coordinator-writes-via-ha-events.md) | Entity-to-coordinator writes via Home Assistant events | Superseded by ADR-0017 |
| [0017](0017-entity-to-coordinator-access-via-ra3-store.md) | Entity-to-coordinator access via RA3's Store (pull-based read, Manager-initiated write) | Proposed |
