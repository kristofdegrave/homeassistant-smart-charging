...
| [0043](0043-scheduled-upstream-drift-watcher.md) | The upstream-drift watcher — a weekly scheduled, issue-writing job over `.claude/profile.yml`'s pin manifest, granted `issues: write` alone | Accepted |
