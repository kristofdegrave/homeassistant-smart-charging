...
| [0027](0027-config-flow-topic-step-structure.md) | Table-driven linear step sequence for the nine-step, topic-grouped config flow | Accepted (point 3's step enumeration narrowed by [ADR-0033](0033-captar-step-gains-a-mapping-half.md)) |
...
| [0033](0033-captar-step-gains-a-mapping-half.md) | External monthly-peak mapping on the CapTar-gated step — `captar` gains a mapping half (narrows ADR-0027 point 3) | Proposed |
