...
plan (drafted 2026-07-04, before this design phase, and never merged, so no copy of it is kept in
this repository) is reconciled against that breakdown in that document's §6.
