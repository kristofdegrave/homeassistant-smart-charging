...
R5 portion of AC10 (the deadline-unreachable notice is undeliverable while the notifications
capability is absent) and of AC11 (`deadline_notice_enabled` gates it further, on top of the
capability, defaulting on).
