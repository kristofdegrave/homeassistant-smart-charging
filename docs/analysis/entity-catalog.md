...
| `input_number.sc_battery_capacity_kwh` | config | kWh | 75 | EV battery capacity (R15) | UC05 | user |
...
| `battery_capacity` | adapter role | kWh | mapped to the vehicle's capacity sensor, when available (optional, NF3) | EV battery capacity, sensed (R15) | UC05 | — |
