...
| `monthly_peak_external` | adapter role | — | kW | mapped to a smart-meter/DSO capacity-tariff peak sensor (NF3; optional — treated as absent, no floor-raising effect, when not configured) | [external monthly-peak reading](system-overview.md#ubiquitous-language) (R3) | resolution-rules | — |
